...
openvost_option_optimization = false;
...
function badFindServers(id) {
    var currentPlayer = activePlayer === "player2" ? player : kinoPlayer;
	if( typeof(goodVideoUrls[id]) == "undefined" || goodVideoUrls[id].length == 0 ) {
		goodVideoUrls[id] = [];
		goodVideoUrls[id].push("http://new.aniland.org/" + id + ".mp4");
		goodVideoUrls[id].push("http://tk.aniland.org/" + id + ".mp4");
		goodVideoUrls[id].push("http://fast.aniland.org/" + id + ".mp4");
		goodVideoUrls[id].push("http://mp4.aniland.org/" + id + ".mp4");
