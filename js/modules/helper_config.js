CONFIG_VAR = {
    ...
    LAZY_LOAD_ANIME_LIST: 'LAZY_LOAD_ANIME_LIST',
...
CONFIG_VAR_CASTS[CONFIG_VAR.LAZY_LOAD_ANIME_LIST] = CONFIG_CASTS.BOOLEAN_TYPE;
CONFIG_VAR_CASTS[CONFIG_VAR.MOVE_PAGE_BLOCK] = CONFIG_CASTS.BOOLEAN_TYPE;
...
CONFIG_VAR_DEFAULT[CONFIG_VAR.LAZY_LOAD_ANIME_LIST] = true;
CONFIG_VAR_DEFAULT[CONFIG_VAR.MOVE_PAGE_BLOCK] = true;
...
CONFIG_VAR_TITLES[CONFIG_VAR.LAZY_LOAD_ANIME_LIST] = 'Потоковая загрузка страниц (beta)';
CONFIG_VAR_TITLES[CONFIG_VAR.MOVE_PAGE_BLOCK] = 'Переместить блок страниц наверх';
