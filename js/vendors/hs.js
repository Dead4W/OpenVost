...
if (!hs) {
    var hs = {
        ...
        setStyles: function(a, b) {
            for (var c in b)
                hs.ieLt9 && "opacity" == c ? 0.99 < b[c] ? a.style.removeAttribute("filter") : a.style.filter = "alpha(opacity=" + 100 * b[c] + ")" : a.style[c] = b[c]
        },
        ...
        getPosition: function(a) {
            for (var b = {
                ...
                a = a.offsetParent,
                    b.x += a.offsetLeft,
                    b.y += a.offsetTop,
                a != document.body && a != document.documentElement && (b.x -= a.scrollLeft,
                    b.y -= a.scrollTop);
            return b
        },
        expand: function(a, b, c, d) {
            ...
            if ("function" == typeof a.getParams)
                return b;
            try {
                return new hs.Expander(a,b,c),
                    !1
            } catch (e) {
                return !0
            }
        ...
        getElementByClass: function(a, b, c) {
            ...
            for (b = 0; b < a.length; b++)
                if (RegExp(c).test(a[b].className))
                    return a[b];
            return null
        },
        replaceLang: function(a) {
            a = a.replace(/\s/g, " ");
            var b = /{hs\.lang\.([^}]+)\}/g, c = a.match(b), d;
            if (c)
                for (var e = 0; e < c.length; e++)
                    d = c[e].replace(b, "$1"),
                    "undefined" != typeof hs.lang[d] && (a = a.replace(c[e], hs.lang[d]));
            return a
        },
        setClickEvents: function() {
            for (var a = document.getElementsByTagName("a"), b = 0; b < a.length; b++)
                hs.isUnobtrusiveAnchor(a[b]) && !a[b].hsHasSetClick && (function() {
        ...
        focusTopmost: function() {
            for (var a = 0, b = -1, c = hs.expanders, d, e = 0; e < c.length; e++)
                (d = c[e]) && (d = d.wrapper.style.zIndex) && d > a && (a = d,
                    b = e);
            -1 == b ? hs.focusKey = -1 : c[b].focus()
        },
        ...
        dim: function(a) {
            ...
            var c = "" == hs.dimmer.owner;
            hs.dimmer.owner += "|" + a.key;
            c && (hs.geckoMac && hs.dimmingGeckoFix ? hs.setStyles(hs.dimmer, {
        ...
        undim: function(a) {
            hs.dimmer && ("undefined" != typeof a && (hs.dimmer.owner = hs.dimmer.owner.replace("|" + a, "")),
            "undefined" != typeof a && "" != hs.dimmer.owner || hs.upcoming && hs.getParam(hs.upcoming, "dimmingOpacity") || (hs.geckoMac && hs.dimmingGeckoFix ? hs.dimmer.style.display = "none" : hs.animate(hs.dimmer, {
                opacity: 0
        ...
        keyHandler: function(a) {
            ...
            if ("undefined" != typeof a.target.form)
                return !0;
            var b = hs.getExpander()
                , c = null;
            switch (a.keyCode) {
                case 70:
                    return b && b.doFullExpand(),
                        !0;
                case 32:
                    c = 2;
                    break;
            ...
            if (null !== c) {
                ...
                if (b)
                    return 0 == c ? b.close() : 2 == c ? b.slideshow && b.slideshow.hitSpace() : (b.slideshow && b.slideshow.pause(),
        ...
        getWrapperKey: function(a, b) {
            ...
            for (c = a; c.parentNode; ) {
                if (void 0 !== c.hsKey)
                    return c.hsKey;
                if (c.id && d.test(c.id))
                    return c.id.replace(d, "$1");
                c = c.parentNode
            }
            if (!b)
                for (c = a; c.parentNode; ) {
                    if (c.tagName && hs.isHsAnchor(c))
                        for (d = 0; d < hs.expanders.length; d++) {
        ...
        reOrder: function() {
            for (var a = 0; a < hs.expanders.length; a++)
                hs.expanders[a] && hs.expanders[a].isExpanded && hs.focusTopmost()
        },
        mouseClickHandler: function(a) {
            ...
            if (1 < a.button)
                return !0;
            a.target || (a.target = a.srcElement);
            for (var b = a.target; b.parentNode && !/highslide-(image|move|html|resize)/.test(b.className); )
                b = b.parentNode;
            ...
            if (c && "mousedown" == a.type) {
                if (a.target.form)
                    return !0;
                if (b = b.className.match(/highslide-(image|move|resize)/))
                    hs.dragArgs = {
                        exp: c,
                        type: b[1],
                        left: c.x.pos,
                    ...
                    /highslide-(image|html)-blur/.test(c.content.className) && (c.focus(),
                        hs.hasFocused = !0)
            } else
                "mouseup" == a.type && (hs.removeEventListener(document, "mousemove", hs.dragHandler),
                    hs.dragArgs ? (hs.styleRestoreCursor && "image" == hs.dragArgs.type && (hs.dragArgs.exp.content.style.cursor = hs.styleRestoreCursor),
                    hs.dragArgs.hasDragged || hs.hasFocused || /(move|resize)/.test(hs.dragArgs.type) || c.close(),
                        hs.hasFocused = !1,
                        hs.dragArgs = null) : /highslide-image-blur/.test(b.className) && (b.style.cursor = hs.styleRestoreCursor));
            return !1
        },
        dragHandler: function(a) {
            ...
            b.hasDragged && 5 < a.clientX && 5 < a.clientY && ("resize" == b.type ? c.resize(b) : (c.moveTo(b.left + b.dX, b.top + b.dY),
            "image" == b.type && (c.content.style.cursor = "move")));
            return !1
        },
        ...
        init: function() {
            if (!hs.container) {
                ...
                for (var a in hs.langDefaults)
                    "undefined" != typeof hs[a] ? hs.lang[a] = hs[a] : "undefined" == typeof hs.lang[a] && "undefined" != typeof hs.langDefaults[a] && (hs.lang[a] = hs.langDefaults[a]);
            ...
            for (var a, b, c = [], d = [], e = {}, f, g = 0; g < hs.openerTagNames.length; g++) {
                ...
                for (var k = 0; k < b.length; k++)
                    if (a = b[k],
                        f = hs.isHsAnchor(a))
                        hs.push(c, a),
                        "hs.expand" == f[0] && hs.push(d, a),
                            f = hs.getParam(a, "slideshowGroup") || "none",
                        e[f] || (e[f] = []),
                            hs.push(e[f], a)
            }
            hs.anchors = {
    ...
    hs.fx.prototype = {
        ...
        custom: function(a, b, c) {
            ...
            d() && 1 == hs.timers.push(d) && (hs.timerId = setInterval(function() {
                for (var a = hs.timers, b = 0; b < a.length; b++)
                    a[b]() || a.splice(b--, 1);
    ...
    hs.Outline = function(a, b) {
        ...
        if (a) {
            ...
            this.td = [];
            for (var e = 0; 8 >= e; e++)
                0 == e % 3 && (c = hs.createElement("tr", null, {
                    height: "auto"
                }, d, !0)),
                    this.td[e] = hs.createElement("td", null, null, c, !0),
                    hs.setStyles(this.td[e], 4 != e ? {
                        lineHeight: 0,
                        fontSize: 0
                    } : {
                        position: "relative"
    ...
    hs.Dimension.prototype = {
        ...
        calcThumb: function() {
            ...
            if (0 == this.tpos || -1 == this.tpos)
                this.tpos = hs.page[this.wh] / 2 + hs.page["scroll" + this.uclt]
        },
        calcExpanded: function() {
            var a = this.exp;
            this.justify = "auto";
            "center" == a.align ? this.justify = "center" : RegExp(this.lt).test(a.anchor) ? this.justify = null : RegExp(this.rb).test(a.anchor) && (this.justify = "max");
            ...
            a.isImage && a.useBox && (this.size = a[this.wh],
        ...
        setSize: function(a) {
            ...
            b.isImage && (b.useBox || hs.padToMinWidth) ? (this.imgSize = a,
                ...
                b.content.style[this.lt] = this.get("imgPad") + "px") : this.size = a;
    ...
    hs.Expander = function(a, b, c, d) {
        if (document.readyState && hs.ie && !hs.isReady)
            ...
            for (f = 0; f < hs.expanders.length; f++)
                if (hs.expanders[f] && hs.expanders[f].a == a && (!this.last || "crossfade" != this.transitions[1]))
                    return hs.expanders[f].focus(),
                        !1;
            if (!hs.allowSimultaneousLoading)
                for (f = 0; f < hs.expanders.length; f++)
                    hs.expanders[f] && hs.expanders[f].thumb != g && !hs.expanders[f].onLoadStarted && hs.expanders[f].cancelLoading();
            hs.expanders[e] = this;
            hs.allowMultipleInstances || hs.upcoming || (hs.expanders[e - 1] && hs.expanders[e - 1].close(),
            "undefined" != typeof hs.focusKey && hs.expanders[hs.focusKey] && hs.expanders[hs.focusKey].close());
            this.el = g;
            ...
            if (!this.outlineType || this.last && this.isImage && "crossfade" == this.transitions[1])
    ...
    hs.Expander.prototype = {
        ...
        showLoading: function() {
            if (!this.onLoadStarted && !this.loading) {
                ...
                if (!d && this.last && "crossfade" == this.transitions[1])
                    var d = this.last;
                d && (b = d.x.get("loadingPosXfade") + "px",
                    c = d.y.get("loadingPosXfade") + "px",
        ...
        contentLoaded: function() {
            try {
                if (this.content && (this.content.onload = null,
                    !this.onLoadStarted)) {
                    ...
                    if (this.allowSizeReduction) {
                        ...
                        if (d && this.last && d.controls && d.fixedControls) {
                            ...
                            for (g in hs.oPos)
                                for (a = 0; 5 > a; a++)
                                    f = this[g],
                                    e.match(hs.oPos[g][a]) && (f.pos = this.last[g].pos + (this.last[g].p1 - f.p1) + (this.last[g].size - f.size) * [0, 0, 0.5, 1, 1][a],
                                    "fit" == d.fixedControls && (f.pos + f.size + f.p1 + f.p2 > f.scroll + f.clientSize - f.marginMax && (f.pos = f.scroll + f.clientSize - f.size - f.marginMin - f.marginMax - f.p1 - f.p2),
                                    f.pos < f.scroll + f.marginMin && (f.pos = f.scroll + f.marginMin)))
                        }
                        this.isImage && this.x.full > (this.x.imgSize || this.x.size) && (this.createFullExpand(),
        ...
        justify: function(a, b) {
            var c, d = a.target, e = a == this.x ? "x" : "y";
            d && d.match(/ /) && (c = d.split(" "),
                d = c[0]);
            if (d && hs.$(d))
                a.pos = hs.getPosition(hs.$(d))[e],
                c && c[1] && c[1].match(/^[-]?[0-9]+px$/) && (a.pos += parseInt(c[1])),
                a.size < a.minSize && (a.size = a.minSize);
                ...
                a.pos < a.scroll + a.marginMin && (a.pos = a.scroll + a.marginMin,
                    c = !0);
                !b && a.size < a.minSize && (a.size = a.minSize,
                    f = !1);
                a.pos + a.get("wsize") > a.scroll + a.clientSize - a.marginMax && (!b && c && f ? a.size = Math.min(a.size, a.get("y" == e ? "fitsize" : "maxsize")) : a.get("wsize") < a.get("fitsize") ? a.pos = a.scroll + a.clientSize - a.marginMax - a.get("wsize") : (a.pos = a.scroll + a.marginMin,
                !b && f && (a.size = a.get("y" == e ? "fitsize" : "maxsize"))));
                !b && a.size < a.minSize && (a.size = a.minSize,
                    f = !1)
            } else
                "max" == a.justify && (a.pos = Math.floor(a.pos - a.size + a.t));
            a.pos < a.marginMin && (e = a.pos,
                a.pos = a.marginMin,
            f && !b && (a.size -= a.pos - e))
        },
        correctRatio: function(a) {
            ...
            e / f > a ? (e = f * a,
            e < b.minSize && (e = b.minSize,
                f = e / a),
                d = !0) : e / f < a && (f = e / a,
                d = !0);
            hs.padToMinWidth && b.full < b.minSize ? (b.imgSize = b.full,
                c.size = c.imgSize = c.full) : this.useBox ? (b.imgSize = e,
                c.imgSize = f) : (b.size = e,
                c.size = f);
            d = this.fitOverlayBox(this.useBox ? null : a, d);
            g && c.size < c.imgSize && (c.imgSize = c.size,
                b.imgSize = c.size * a);
            if (d || g)
        ...
        fitOverlayBox: function(a, b) {
            var c = this.x
                , d = this.y;
            if (this.overlayBox)
                for (; d.size > this.minHeight && c.size > this.minWidth && d.get("wsize") > d.get("fitsize"); )
                    d.size -= 10,
                    a && (c.size = d.size * a),
        ...
        changeSize: function(a, b, c) {
            ...
            if (this[d] && "expand" != d)
                ...
                a && (this.wrapper.style.visibility = "visible",
        ...
        fade: function(a, b) {
            ...
            a && (hs.animate(this.wrapper, b.wrapper, 0),
                hs.setStyles(this.wrapper, {
                    opacity: 0,
                    visibility: "visible"
                }),
                hs.animate(this.content, b.content, 0),
                this.content.style.visibility = "visible",
            ...
            if (this.outline) {
                ...
                for (var e = a || -1, f = this.outline.offset, g = a ? 3 : f, k = a ? f : 3, l = g; e * l <= e * k; l += e,
                    d += 25)
                    (function() {
                            var b = a ? k - l : g - l;
                            setTimeout(function() {
        ...
        crossfade: function(a, b, c) {
            if (a) {
                ...
                for (var n in a)
                    this[n] = a[n].content.cloneNode(1),
                        hs.setStyles(this[n], {
                            position: "absolute",
                            border: 0,
                            visibility: "visible"
                ...
                hs.animate(r, {
                    ...
                    step: function(a, b) {
                        var c = b.pos, q = 1 - c, p, h = {}, n = ["pos", "size", "p1", "p2"], u;
                        for (u in n)
                            p = n[u],
                                h["x" + p] = Math.round(q * k[p] + c * f[p]),
                                h["y" + p] = Math.round(q * l[p] + c * g[p]),
                                h.ximgSize = Math.round(q * (k.imgSize || k.size) + c * (f.imgSize || f.size)),
                                h.ximgPad = Math.round(q * k.get("imgPad") + c * f.get("imgPad")),
                                h.yimgSize = Math.round(q * (l.imgSize || l.size) + c * (g.imgSize || g.size)),
                                h.yimgPad = Math.round(q * l.get("imgPad") + c * g.get("imgPad"));
                    ...
                    complete: function() {
                        r.style.visibility = t.style.visibility = "visible";
        ...
        reuseOverlay: function(a, b) {
            ...
            for (var c = 0; c < this.last.overlays.length; c++) {
                ...
                if (d && d.hsId == a.hsId)
                    return this.genOverlayBox(),
                        d.reuse = this.key,
                        hs.push(this.overlays, this.last.overlays[c]),
                        !0
            }
            return !1
        },
        ...
        getNumber: function() {
            if (this[this.numberPosition]) {
                ...
                a && (a = hs.lang.number.replace("%1", this.getAnchorIndex() + 1).replace("%2", a.length),
                    this[this.numberPosition].innerHTML = '<div class="highslide-number">' + a + "</div>" + this[this.numberPosition].innerHTML)
            }
        },
        initSlideshow: function() {
            if (this.last)
                ...
                for (var a = 0; a < hs.slideshows.length; a++) {
                    var b = hs.slideshows[a]
                        , c = b.slideshowGroup;
                    if ("undefined" == typeof c || null === c || c === this.slideshowGroup)
        ...
        getInline: function(a, b) {
            for (var c = 0; c < a.length; c++) {
                ...
                if (!this[d] && !this[d + "Text"] && this[d + "Eval"])
                    try {
                        e = eval(this[d + "Eval"])
                    } catch (f) {}
                !this[d] && this[d + "Text"] && (e = this[d + "Text"]);
                if (!this[d] && !e && (this[d] = hs.getNode(this.a["_" + d + "Id"]),
                    !this[d]))
                    for (var g = this.a.nextSibling; g && !hs.isHsAnchor(g); ) {
                        if (RegExp("highslide-" + d).test(g.className || null)) {
                ...
                if (b && this[d]) {
                    ...
                    for (k in this[d + "Overlay"])
                        e[k] = this[d + "Overlay"][k];
                    e.overlayId = this[d];
        ...
        focus: function() {
            ...
            hs.restoreCursor && (hs.styleRestoreCursor = window.opera ? "pointer" : "url(" + hs.graphicsDir + hs.restoreCursor + "), pointer",
            hs.ieLt7 && 6 > hs.uaVersion && (hs.styleRestoreCursor = "hand"),
        ...
        close: function() {
            if (!this.isClosing && this.isExpanded) {
                "crossfade" == this.transitions[1] && hs.upcoming && (hs.getExpander(hs.upcoming).cancelLoading(),
                    hs.upcoming = null);
                this.isClosing = !0;
        ...
        createOverlay: function(a) {
            ...
            if (b && "string" != typeof b && (b.style.display = "block",
                a.hsId = a.hsId || a.overlayId,
            "crossfade" != this.transitions[1] || !this.reuseOverlay(a, b))) {
                this.genOverlayBox();
                ...
                hs.extend(d, a);
                this.gotOverlays && (this.positionOverlay(d),
                d.hideOnMouseOut && !this.mouseIsOver || hs.animate(d, {
                    opacity: d.opacity
                }, d.dur));
        ...
        positionOverlay: function(a) {
            var b = a.position || "middle center"
                ...
                , d = a.offsetX
                , e = a.offsetY;
            c ? (hs.viewport.style.display = "block",
                a.hsKey = this.key,
            a.offsetWidth > a.parentNode.offsetWidth && (a.style.width = "100%")) : a.parentNode != this.overlayBox && this.overlayBox.appendChild(a);
        ...
        sizeOverlayBox: function(a, b) {
            ...
            if (a || b)
                for (var f = 0; f < this.overlays.length; f++) {
                    ...
                    g && /^(above|below)$/.test(g.position) && (k && (g.style.width = c.offsetWidth + 2 * d.cb + d.p1 + d.p2 + "px"),
                        e["above" == g.position ? "p1" : "p2"] = g.offsetHeight);
    ...
    hs.Slideshow.prototype = {
        getControls: function() {
            ...
            this.btn = {};
            for (var b = 0; b < a.length; b++)
                this.btn[a[b]] = hs.getElementByClass(this.controls, "li", "highslide-" + a[b]),
                    this.enable(a[b]);
        ...
        checkFirstAndLast: function() {
            if (!this.repeat && this.controls) {
                ...
                b + 1 == hs.anchors.groups[a.slideshowGroup || "none"].length ? (this.disable("next"),
                    this.disable("play")) : c.test(this.btn.next.getElementsByTagName("a")[0].className) && (this.enable("next"),
                    this.enable("play"))
            }
        },
        enable: function(a) {
        ...
        disable: function(a) {
            this.btn && (a = this.btn[a].getElementsByTagName("a")[0],
                a.onclick = function() {
                    return !1
                }
                ,
        ...
        play: function(a) {
            this.btn && (this.btn.play.style.display = "none",
                this.btn.pause.style.display = "");
            this.autoplay = !0;
            a || hs.next(this.expKey)
        },
        pause: function() {
            this.btn && (this.btn.pause.style.display = "none",
    ...
    hs.addEventListener(document, "ready", function() {
        if (hs.expandCursor || hs.dimmingOpacity) {
            var a = hs.createElement("style", {
                ...
                , c = function(c, d) {
                if (hs.ie && (9 > hs.uaVersion || b)) {
                    var g = document.styleSheets[document.styleSheets.length - 1];
                    "object" == typeof g.addRule && g.addRule(c, d)
                } else
            ...
            c(".highslide-viewport-size", hs.ie && (7 > hs.uaVersion || b) ? "position: absolute; left:" + d("scrollLeft") + "top:" + d("scrollTop") + "width:" + d("clientWidth") + "height:" + d("clientHeight") : "position: fixed; width: 100%; height: 100%; left: 0; top: 0")
        }
    });
